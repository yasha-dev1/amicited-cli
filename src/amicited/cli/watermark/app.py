...
def remove_command(
    ...
    temperature: float = typer.Option(
        ...
        min=0.0,
        max=2.0,
        help="Sampling temperature for the API provider.",
    ),
    ...
    max_chunk_words: int = typer.Option(
        ...
        "--max-chunk-words",
        min=1,
        help="Maximum words in each paragraph-level semantic request.",
    ),
    max_concurrency: int = typer.Option(
        ...
        min=1,
        max=32,
        help="Maximum semantic provider requests to run concurrently.",
    ),
    lexical_diversity: int = typer.Option(
        60,
        "--lexical-diversity",
        min=0,
        max=100,
        help="Target amount of vocabulary and phrasing change, from 0 to 100.",
    ),
    order_diversity: int = typer.Option(
        40,
        "--order-diversity",
        min=0,
        max=100,
        help="Target amount of sentence and clause reordering, from 0 to 100.",
    ),
